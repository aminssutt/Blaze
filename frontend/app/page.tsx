 ...
 *
 * Four sections: hero thesis → 01 why now (real 2026 wildfire facts,
 * sourced) → 02 animated pipeline diagram with the human-veto line, the
 * voice-order result and a demo-orientation teaser → final CTA + one-line
 * footer. Static page — no store, no event source; all motion is
 * client-side and honors prefers-reduced-motion.
 */
