<p align="center">
  <img src="docs/assets/blaze-banner.png" alt="BLAZE — turns radio chatter into command decisions" width="100%" />
</p>
...
Then open **http://localhost:3000/demo** for the guided cinematic run — or `/simple`, `/expert` and `/system` for the operator views, `/monitor` for the live pipeline graph.
...
frontend/   Next.js control room — /demo, /simple, /expert, /system, /monitor
